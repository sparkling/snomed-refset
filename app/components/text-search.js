  ...
  tsComponent.reopenClass({
    find: function(searchString, pageIndex, pageSize){
      ...
      return Ember.Deferred.promise(function(p) {
        ...
        p.resolve($.getJSON("https://solr.sparklingideas.co.uk/solr/concept/select?q=title:" + searchString + "&start=" + startIndex + "&rows=" + pageSize + "&wt=json&indent=true&json.wrf=?")
          .then(function(solr) {
